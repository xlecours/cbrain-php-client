...
/**
 * BourreauxApi Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
...
class BourreauxApi
{
    ...
    {
        $returnType = '\Swagger\Client\Model\Bourreau[]';
        $request = $this->bourreauxGetRequest();
     ...
     */
    public function bourreauxGetAsync()
    {
        return $this->bourreauxGetAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation bourreauxGetAsyncWithHttpInfo
     *
     * Get a list of the Bourreaux available to be used by the current user.
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function bourreauxGetAsyncWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\Bourreau[]';
        $request = $this->bourreauxGetRequest();
    ...
    /**
     * Create request for operation 'bourreauxGet'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function bourreauxGetRequest()
    {
    ...
    {
        $returnType = '\Swagger\Client\Model\Bourreau';
        $request = $this->bourreauxIdGetRequest($id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function bourreauxIdGetAsync($id)
    {
        return $this->bourreauxIdGetAsyncWithHttpInfo($id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation bourreauxIdGetAsyncWithHttpInfo
     *
     * Get information about a Bourreau.
     *
     * @param  int $id ID of the Bourreau to get information on. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function bourreauxIdGetAsyncWithHttpInfo($id)
    {
        $returnType = '\Swagger\Client\Model\Bourreau';
        $request = $this->bourreauxIdGetRequest($id);
    ...
    /**
     * Create request for operation 'bourreauxIdGet'
     *
     * @param  int $id ID of the Bourreau to get information on. (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function bourreauxIdGetRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling bourreauxIdGet'
            );
        }
