...
class UsersApi
{
     ...
     *
     * @param  int $id ID of user to update (required)
     * @param  \Swagger\Client\Model\UserModReq $user_mod_req An object representing a request for a new User (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\User
     */
    public function usersIdPatch($id, $user_mod_req)
    {
        list($response) = $this->usersIdPatchWithHttpInfo($id, $user_mod_req);
        return $response;
    }
     ...
     * @return array of \Swagger\Client\Model\User, HTTP status code, HTTP response headers (array of strings)
     */
    public function usersIdPatchWithHttpInfo($id, $user_mod_req)
    {
        $returnType = '\Swagger\Client\Model\User';
        $request = $this->usersIdPatchRequest($id, $user_mod_req);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function usersIdPatchAsync($id, $user_mod_req)
    {
        return $this->usersIdPatchAsyncWithHttpInfo($id, $user_mod_req)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function usersIdPatchAsyncWithHttpInfo($id, $user_mod_req)
    {
        $returnType = '\Swagger\Client\Model\User';
        $request = $this->usersIdPatchRequest($id, $user_mod_req);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function usersIdPatchRequest($id, $user_mod_req)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException(
        ...
        if ($user_mod_req === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $user_mod_req when calling usersIdPatch'
            );
        }
        ...
        // body params
        $_tempBody = null;
        if (isset($user_mod_req)) {
            $_tempBody = $user_mod_req;
        }
     ...
     * @return \Swagger\Client\Model\User
     */
    public function usersPost($user_mod_req)
    {
        list($response) = $this->usersPostWithHttpInfo($user_mod_req);
        return $response;
    }
     ...
     * @return array of \Swagger\Client\Model\User, HTTP status code, HTTP response headers (array of strings)
     */
    public function usersPostWithHttpInfo($user_mod_req)
    {
        $returnType = '\Swagger\Client\Model\User';
        $request = $this->usersPostRequest($user_mod_req);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function usersPostAsync($user_mod_req)
    {
        return $this->usersPostAsyncWithHttpInfo($user_mod_req)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function usersPostAsyncWithHttpInfo($user_mod_req)
    {
        $returnType = '\Swagger\Client\Model\User';
        $request = $this->usersPostRequest($user_mod_req);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function usersPostRequest($user_mod_req)
    {
        // verify the required parameter 'user_mod_req' is set
        if ($user_mod_req === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $user_mod_req when calling usersPost'
            );
        }
