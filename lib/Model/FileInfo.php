...
class FileInfo implements ModelInterface, ArrayAccess
{
     ...
     * Sets group
     *
     * @param string $group string representation of gid, the group's name
     *
     * @return $this
     */
     ...
     * Sets owner
     *
     * @param string $owner string representation of uid, the owner's name
     *
     * @return $this
     */
     ...
     * Sets size
     *
     * @param float $size size of file in bytes
     *
     * @return $this
     */
     ...
     * Sets state_ok
     *
     * @param bool $state_ok flag that tell whether or not it's OK to register/unregister
     *
     * @return $this
     */
