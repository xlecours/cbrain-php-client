...
class Userfile implements ModelInterface, ArrayAccess
{
     ...
     * Sets user_id
     *
     * @param int $user_id ID of the owner of the file.
     *
     * @return $this
     */
     ...
     * Sets parent_id
     *
     * @param int $parent_id ID of the parent Userfile, if any exists, or null otherwise.
     *
     * @return $this
     */
     ...
     * Sets group_id
     *
     * @param int $group_id ID of the group that owns the file, which determines its visibility status.
     *
     * @return $this
     */
     ...
     *
     * @param int $data_provider_id ID of the Data Provider that is hosting the persistent copy of the file. It may exist in caches across the systems that make up CBRAIN, as copies of the file are made in order to run scientific programs on them on remote systems.
     *
     * @return $this
     */
     ...
     * Sets num_files
     *
     * @param int $num_files Number of files that the Userfiles represents. For Single Files, this is always 1.
     *
     * @return $this
     */
