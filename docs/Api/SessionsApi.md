...
# **sessionGet**
> \Swagger\Client\Model\InlineResponse2003 sessionGet()
...
# **sessionPost**
> \Swagger\Client\Model\InlineResponse2004 sessionPost($login, $password)
...
$login = "admin"; // string | The username of the User trying to connect.
